...
const EKOSPOT_SYSTEM_PROMPT = `You are EkoSpot Concierge, the warm and knowledgeable AI assistant for EkoSpot — Lagos's curated guide to restaurants, nightlife, beaches, culture, cafes, and the hottest spots across Lagos State.
...
- Explain how EkoSpot works (saving spots, tiers — Explorer, Scout, Ambassador)
...
Key facts about EkoSpot:
- EkoSpot curates the best spots across Lagos State — restaurants, nightlife, beaches, culture & arts, cafes, and hangouts
...
export async function POST(request: NextRequest) {
  try {
    ...
    const allMessages: Array<{ role: "system" | "user" | "assistant"; content: string }> = [
      { role: "system", content: EKOSPOT_SYSTEM_PROMPT },
